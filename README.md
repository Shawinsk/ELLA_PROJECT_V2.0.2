...
> **E.L.L.A** = **E**legant **L**anguage & **L**ogic **A**ssistant
...
ELLA's "Minority Report" interface uses your webcam to detect hand gestures:
...
To use the secure voice features, ELLA needs to know what you look like.
...
ELLA V2 can slice STL files and send them directly to your 3D printer.
...
ELLA uses **OrcaSlicer** (recommended) or PrusaSlicer to generate G-code.

1. Download and install [OrcaSlicer](https://github.com/SoftFever/OrcaSlicer).
2. Run it once to ensure profiles are created.
3. ELLA automatically detects the installation path.

**Step 2: Connect Printer**

1. Ensure your printer and computer are on the **same Wi-Fi network**.
2. Open the **Printer Window** in ELLA (Cube icon).
3. ELLA automatically scans for printers using mDNS.
...
ELLA uses Google's Gemini API for voice and intelligence. You need a free API key.
...
1. **Voice Check**: Say "Hello Ella". She should respond.
...
- **Auto-Discovery**: ELLA automatically finds printers on your network.
- **Slicing**: Click "Slice & Print" on any generated 3D model.
- **Profiles**: ELLA intelligently selects the correct OrcaSlicer profile based on your printer's name (e.g., "Creality K1").
...
**Solution**:
This is a server-side issue from the Gemini API. Simply reconnect by clicking the connect button or saying "Hello Ella" again. If it persists, check your internet connection or try again later.
